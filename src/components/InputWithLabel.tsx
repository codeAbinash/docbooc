...
export default function InputWithLabel({ label, isOptional, value, leftIcon, ...props }: InputWithLabelProps) {
  ...
  return (
    <View className='gap-2'>
      ...
      <View
        className='flex-row  items-center rounded-2xl bg-white dark:bg-neutral-900'
        style={{
          borderWidth: 1,
      ...
      >
        ...
        <TextInput
          ...
          className={`flex-1 text-base text-neutral-900 dark:text-white ${leftIcon ? 'pl-3' : 'px-4'} py-3 pr-4`}
          style={MEDIUM}
        />
      </View>
    </View>
