...
export default function ProfileScreen() {
  ...
  return (
    <View className='flex-1 bg-white'>
      <HybridHead title='Profile' showBackButton />
          ...
          <View className='pb-6'>
            <View className='overflow-hidden rounded-2xl border border-neutral-300 bg-white p-5 dark:bg-neutral-800'>
              ...
              <View className='gap-4'>
                {/* Saved Address */}
                <Press className='flex-row items-center p-2'>
                ...
                <Press className='flex-row items-center p-2'>
                  ...
                  <View className='flex-1'>
                    <Medium className='text-xs text-neutral-500 dark:text-neutral-400'>Upcoming Appointments</Medium>
                    <Medium className='text-sm text-neutral-900 dark:text-white'>Check upcoming appointments</Medium>
                  </View>
                  <ArrowLeft01Icon color={scheme === 'dark' ? '#6b7280' : '#d1d5db'} size={20} strokeWidth={2} />
                </Press>
                ...
                <Press className='flex-row items-center p-2'>
                  ...
                  <View className='flex-1'>
                    <Medium className='text-xs text-neutral-500 dark:text-neutral-400'>Family Members</Medium>
                    <Medium className='text-sm text-neutral-900 dark:text-white'>Manage linked family members</Medium>
                  </View>
                  <ArrowLeft01Icon color={scheme === 'dark' ? '#6b7280' : '#d1d5db'} size={20} strokeWidth={2} />
                </Press>
                ...
                <Press className='flex-row items-center p-2'>
                  ...
                  <View className='flex-1'>
                    <Medium className='text-xs text-neutral-500 dark:text-neutral-400'>Confirmed Appointments</Medium>
                    <Medium className='text-sm text-neutral-900 dark:text-white'>
                      Check appointments those are confirmed
                    </Medium>
                  </View>
                  <ArrowLeft01Icon color={scheme === 'dark' ? '#6b7280' : '#d1d5db'} size={20} strokeWidth={2} />
                </Press>
                ...
                <Press className='flex-row items-center p-2'>
                  ...
                  <View className='flex-1'>
                    <Medium className='text-xs text-neutral-500 dark:text-neutral-400'>Provisional Appointments</Medium>
                    <Medium className='text-sm text-neutral-900 dark:text-white'>
                      Check appointments that need confirmation
                    </Medium>
                  </View>
                  <ArrowLeft01Icon color={scheme === 'dark' ? '#6b7280' : '#d1d5db'} size={20} strokeWidth={2} />
                </Press>
